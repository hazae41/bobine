...
export function main(): boolean {
  const pubkey = bytes.fromHex(blobs.save(String.UTF8.encode("E0293454F6B94439F24BE13CD9DE35C5A2958808B3932A518A33161CB1D811E8")))
  const signature = bytes.fromHex(blobs.save(String.UTF8.encode("146BD4C4BFC4B13FC3BE444F9A65DEBD684339E251E07A37AC486E283B8953FF7EBEEFB0F8334BDEE30A9F17F2B0232625F8FEA559A27A2279AB32BF2151660C")))
  const payload = blobs.save(String.UTF8.encode("hello world"))
