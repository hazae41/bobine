...
namespace modules {
  ...
  // @ts-ignore: decorator
  @external("modules", "morph")
  export declare function morph(code: externref): void

}

export function version(): usize {
  return 2
}

export function upgrade(module: externref): void {
  modules.morph(modules.load(module))
}